const customer_balance_schema = require("../model/customer_balance")

const create_balance = async (req, res) => {
            ...
            axios.request(config)
                  .then((response) => {
                        ...
                        data.map(async (items, index) => {
                              const new_detail = new customer_balance_schema({ ...items, ...{ PASSWORD: "123456" } })
